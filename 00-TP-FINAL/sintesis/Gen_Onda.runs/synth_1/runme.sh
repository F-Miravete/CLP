...
HD_PWD='C:/01 - ELECTRONICA/Especializaciones/CESE/10 Circuitos Logicos Programables/Practicas/CLP/00-TP-FINAL/sintesis/Gen_Onda.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log waveGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source waveGenerator.tcl
