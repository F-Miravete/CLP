...
HD_PWD='C:/01 - ELECTRONICA/Especializaciones/CESE/10 Circuitos Logicos Programables/Practicas/CLP/00-TP-FINAL/sintesis/Gen_Onda_VIO_ILA.runs/vio_0_synth_1'
cd "$HD_PWD"
