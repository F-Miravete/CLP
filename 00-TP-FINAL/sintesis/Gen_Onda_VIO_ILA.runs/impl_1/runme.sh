...
HD_PWD='C:/01 - ELECTRONICA/Especializaciones/CESE/10 Circuitos Logicos Programables/Practicas/CLP/00-TP-FINAL/sintesis/Gen_Onda_VIO_ILA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log waveGenerator_VIO_ILA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source waveGenerator_VIO_ILA.tcl -notrace
